...
# 
# grt_long <- melt(grt_wide,id.vars = "person",variable.name = "item",
#                  value.name = "response")
# grt_long$occasion <- as.factor(ifelse(grepl(pattern = 01,x = grt_long$item),1,2))
# grt_long$question <- as.factor(gsub(pattern = "x_o[1-2]_i",
#                                      replacement = "",
#                                      x = grt_long$item))
...
The model implied here can be written as $$ model model model$$. The ven diagram for the variances is seen below:
